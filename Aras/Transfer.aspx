    ...
    <div class="container">
        ...
        <div class="border">
            <form id="form1" runat="server">
                <div class="row container">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-6 mt-0">
                        <div class="form-group">
                            <label for="fromWareHouseDropDownList" class="col-form-label styleK text-right">لە مەخزەنی</label>
                            <asp:DropDownList ID="fromWareHouseDropDownList" Style="padding-top: 0; padding-bottom: 0; font-size: 12px;"
                                runat="server" CssClass="form-control invois_multK" AutoPostBack="True" OnSelectedIndexChanged="fromWareHouseDropDownList_SelectedIndexChanged1">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-6 mt-0">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-6 mt-0">
                    <div class="form-group">
                        <label for="fromWareHouseDropDownList" class="col-form-label styleK text-right">بوونی مەواد لە مەخزەن</label>
                        <asp:TextBox ID="AmountInWareHouseTextBox" CssClass="form-control form-control-lg" runat="server" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
