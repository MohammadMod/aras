<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show Expinces.aspx.cs" Inherits="Aras.Show_Expinces" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>view Expensive</title>
        ...
        <form id="form1" runat="server">
            <div class="form-row pb-2 ">
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-6 my-1 text-right">
                    ...
                    <asp:Button ID="NewExpinsive" runat="server" CssClass="btn btn-primary btn-sm styleK" OnClick="NewExpinsive_Click" Text="مەسروفی نوێ" />
