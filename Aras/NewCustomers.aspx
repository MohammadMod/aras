      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-right">
            <h4 class="styleK">چیشتخانەیەکی نوێ</h4>
          </div>
        </div>
      </div>
      <hr>
                ...
                <form id="form1" runat="server">
                    ...
                    <div class="col-lg-10 mt-0 ">
                        ...
                        <div class="form-group ">
                            <label for="CostumerNameTextBox" class="col-form-label styleK">ناو</label>
                            <asp:TextBox ID="CostumerNameTextBox" CssClass="form-control form-control-lg" required ="required" runat="server"></asp:TextBox>
                        </div>
                    </div>

                    <div class="col-lg-10 mt-0">
                        <div class="form-group">
                            <label for="ResturantNameTextBox" class="col-form-label styleK">ناوی چێشخانە</label>
                            <asp:TextBox ID="ResturantNameTextBox" required ="required" CssClass="form-control form-control-lg" runat="server"></asp:TextBox>  
                        </div>
                    </div>
                    
                    <div class="col-lg-10 mt-0">
                        <div class="form-group">
                            <label for="LocationTextBox" class="col-form-label styleK">شوین</label>
                            <asp:TextBox ID="LocationTextBox" required ="required" CssClass="form-control form-control-lg" runat="server"></asp:TextBox>
                        </div>
                    </div>

                    <div class="col-lg-10 mt-0">
                        <div class="form-group">
                            <label for="PhoneNumberTextBox" class="col-form-label styleK">ژمارەی تەڵەفۆن</label>
                            <asp:TextBox ID="PhoneNumberTextBox" CssClass="form-control form-control-lg" required ="required" runat="server"></asp:TextBox>
                        </div>
                    </div>

                    <div class="col-lg-6 mt-0">
                        <div class="form-group">
                            <label for="MoneyInDeptTextBox" class="col-form-label styleK">پارەی قەرز</label>
                            <asp:TextBox ID="MoneyInDeptTextBox" CssClass="form-control form-control-lg" runat="server" required ="required" ></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="form-check col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <asp:CheckBox ID="DisablesCheckBox" CssClass="styleK" runat="server" Checked="false" Text="ناچالاکە ?" />
                    </div>
