            ...
            <form id="form1" runat="server">
                <div class="col-lg-8 mt-0">
                    <div class="form-group">
                        <label for="amountTextBox" class="col-form-label styleK">پاڕە</label>
                        <asp:TextBox ID="amountTextBox" TextMode="Number" CssClass="form-control form-control" runat="server"></asp:TextBox>
                    </div>
                </div>

                <div class="col-lg-8 mt-0">
                    <div class="form-group">
                        <label for="amountTextBox" class="col-form-label styleK">تێبینی </label>
                        <asp:TextBox ID="detailsTextBox" placeholder="تێبینی" CssClass="form-control form-control" runat="server" TextMode="MultiLine"></asp:TextBox>
                    </div>
                </div>
